...
**gym_app/models.py:** *En este archivo definimos los modelos, los cuales definen la estructura de los datos almacenados. Por ejemplo en este caso, definimos los modelos para inscripcion, entrenador y contacto.*
...
**settings.py:** *En este archivo se encuentra la configuracion para los archivos estáticos.*


**Orde de los archivos:**
